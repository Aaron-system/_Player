...
def decrease_volume():
    try:
        ...
        print(e)
        song_title_label.config(fg="red", text="Track hasn't been selected for yet")
...
# Main Screen
master = Tk()
master.title("Music Player by @Aaron K")

# Label
Label(master, text="Custom Music Player", font=("Arial", 15), fg="red").grid(sticky="N", row=0, padx=120)
Label(master, text="Please select a song you would like to play", font=("Arial", 12), fg="blue").grid(sticky="N", row=1,
                                                                                                      padx=120)
Label(master, text="Volume", font=("Arial", 12), fg="red").grid(sticky="N", row=4, padx=120)
song_title_label = Label(master, font=("Arial", 12))
song_title_label.grid(sticky="N", row=3)
volume_label = Label(master, font=("Arial", 12))
...
Button(master, text="-", font=("Arial", 12), width=5, command=decrease_volume).grid(row=5, sticky="W")
